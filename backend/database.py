...
def _seed_edition_analytics():
    ...
    seed = [
        {
            'id': 'seed-2023', 'year': 2023, 'edition_name': 'Way of Life Festival 2023',
            ...
            'familles_json': json.dumps([
                {'name': 'Cocktails',          'ca': 321724},
                {'name': 'Bières Artisanales', 'ca': 98418},
                {'name': 'Vins Naturels',      'ca': 94321},
                {'name': 'Soft & Hydration',   'ca': 81369},
                {'name': 'Spiritueux',         'ca': 45401},
                {'name': 'Rhum & Punch',       'ca': 27078},
            ]),
            'pass_culture_json': json.dumps({'ventes': 1259, 'ca': 188850}),
            'notes': 'Way of Life Festival 2023 — données de démonstration',
        },
        {
            'id': 'seed-2024', 'year': 2024, 'edition_name': 'Way of Life Festival 2024',
            ...
            'familles_json': json.dumps([
                {'name': 'Cocktails',          'ca': 304606},
                {'name': 'Vins Naturels',      'ca': 109198},
                {'name': 'Bières Artisanales', 'ca': 65238},
                {'name': 'Soft & Hydration',   'ca': 44606},
                {'name': 'Rhum & Punch',       'ca': 25447},
                {'name': 'Street Food',        'ca': 20468},
            ]),
            'pass_culture_json': json.dumps({'ventes': 1775, 'ca': 225320}),
            'notes': 'Way of Life Festival 2024 — données de démonstration',
        },
        {
            'id': 'seed-2025', 'year': 2025, 'edition_name': 'Way of Life Festival 2025',
            ...
            'familles_json': json.dumps([
                {'name': 'Cocktails',          'ca': 178857},
                {'name': 'Bières Artisanales', 'ca': 59005},
                {'name': 'Soft & Hydration',   'ca': 44386},
                {'name': 'Vins Naturels',      'ca': 33924},
                {'name': 'Street Food',        'ca': 27581},
                {'name': 'Spiritueux',         'ca': 18775},
                {'name': 'Kombucha & Bio',     'ca': 17678},
            ]),
            'pass_culture_json': json.dumps({'ventes': 516, 'ca': 61920}),
            'notes': 'Way of Life Festival 2025 — données de démonstration',
        },
    ]
    with get_db() as conn:
        for row in seed:
